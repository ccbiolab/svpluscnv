...
```{r plot_vignette_1,  fig.width=12, fig.height=10, fig.align='left', fig.cap = "Figure S1. Visualization of CNV frequencies with cnv.freq", message=TRUE}
...
```{r plot_vignette_2,  fig.width=12, fig.height=14, fig.align='left', fig.cap = "Supplementary Figure S2. Recurrent SVs in Breast Cancer tumors and cell lines", message=TRUE}
...
```{r plot_vignette_3,  fig.width=12, fig.height=10, fig.align='left', fig.cap = "Supplementary Figure S3. Validation of breakpoints from orthogonal sources", message=TRUE}
...
```{r plot_vignette_4,  fig.width=12, fig.height=10, fig.align='left', fig.cap = "Supplementary Figure S4. Identification of shattered region hot-spots in breast cancer", message=TRUE}
