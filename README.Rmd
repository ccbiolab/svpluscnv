...
```{r plot_readme_1,  fig.width=12, fig.height=4, fig.align='left', fig.cap = "Genome wide CNV frequencies", message=FALSE}
...
```{r plot_readme_2, fig.width=12, fig.height=7, fig.align='left', fig.cap = "SV versus CNV breakpoint burden",  message=FALSE}
...
```{r plot_readme_3, fig.width=9, fig.height=5, fig.align='left', fig.cap = "SV versus CNV breakpoint burden",  message=FALSE}
...
```{r plot_readme_3b, fig.width=12, fig.height=4, fig.align='left', fig.cap = "SV versus CNV breakpoint burden",  message=FALSE}
# SVC corrected breakpoint burden
par(mar=c(1,5,1,1))
svc.brk.iqm <- brk.burden.iqm(svc_breaks)
```

```{r plot_readme_3c, fig.width=12, fig.height=4, fig.align='left', fig.cap = "SV versus CNV breakpoint burden",  message=FALSE}
# SVC corrected breakpoint burden
par(mar=c(1,5,1,1))
cnv.brk.iqm <- brk.burden.iqm(cnv_breaks)
```

```{r plot_readme_3d, fig.width=9, fig.height=5, fig.align='left', fig.cap = "SV versus CNV breakpoint burden",  message=FALSE}
...
```{r plot_readme_4,  fig.width=12, fig.height=10, fig.align='left', fig.cap = "Common breakpoints by sample",  message=FALSE}
...
```{r plot_readme_5, fig.width=9, fig.height=5, fig.align='left', fig.cap = "Circos plot representing c LUNG cancer cell lines with chromothripsis",  message=FALSE}
...
```{r plot_readme_6, fig.width=9, fig.height=5, fig.align='left', fig.cap = "Circos plot representing c LUNG cancer cell lines with chromothripsis",  message=FALSE}
set.seed(12345678)
...
```{r plot_readme_7,  fig.width=12, fig.height=4, fig.align='left', fig.cap = "Recurrently shattered regions map", message=FALSE}
...
```{r plot_readme_8,  fig.width=9, fig.height=5, fig.align='left', fig.cap = "Recurrently altered genes with overlapping CNV breakpoints", message=FALSE}
...
```{r plot_readme_9,  fig.width=9, fig.height=5, fig.align='left', fig.cap = "Recurrently altered genes with overlapping CNV breakpoints", message=FALSE}
...
```{r plot_readme_10,  fig.width=9, fig.height=12, fig.align='left', fig.cap = "Visualizaion of structural variants in PTPRD", message=FALSE}
